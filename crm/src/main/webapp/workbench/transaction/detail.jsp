...
<script type="text/javascript">
	...
	function changeIcon(listStage,index1) {
        ...
        //准备前面正常阶段和后面丢失阶段的分界点下标
        var point = "<%=point%>";
        //如果当前阶段的可能性为0，前七个一定是黑圈后两个一个是红叉一个是黑叉
        if("0"==currentPossibility){
            ...
            //如果当前阶段的可能性不为0前七个有可能是绿圈，绿色标记，黑圈
        }else{
            //遍历前七个
            for(var i = 0;i<point;i++){
                if(i==index){
...
<body>
	...
	<div style="position: relative; left: 40px; top: -50px;">
		...
		<%
			...
			//如果当前阶段可能性不为0 前7个有可能是绿圈，绿色标记，黑圈，后两个一定是黑叉
		}else{
