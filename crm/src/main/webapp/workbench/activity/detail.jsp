...
<script type="text/javascript">
	...
	$(function(){
		...
		//页面加载完毕后（市场活动详细信息展现完毕后），展现关联的市场活动备注列表
		showRemarkList();
        ...
        $("#updateRemarkBtn").click(function () {
            ...
            $.ajax({
                ...
                success:function (data) {
                    ...
                    if(data.success){
                        //修改备注成功
                        //更新列表中响应的信息 noteContent editTime editBy
                        //更新noteContent
    ...
    function editRemark(id) {
        //取得需要修改信息所在的h5标签对，取得标签对中的信息，就是将需要修改的信息取得了
        var noteContent = $("#e"+id).html();
        //将需要修改的信息，添加到修改操作的模态窗口中
